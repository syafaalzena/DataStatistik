...
<div class="container pb-5">
    <div class="d-flex align-items-center gap-3 mb-4 flex-wrap">
        ...
        <div>
            <h2 class="fw-bold mb-1">Data Tangkap Provinsi Aceh</h2>
            <p class="text-muted mb-0">Silakan pilih kabupaten untuk mengelola data produksi tangkap.</p>
        </div>
    </div>
    ...
    <div class="kab-list" id="kabList">
        @forelse($kabupatenIkans as $kab)
            <a href="{{ route('tangkap.input', $kab->id) }}" class="kab-item" data-name="{{ strtolower($kab->nama_kabupaten) }}">
