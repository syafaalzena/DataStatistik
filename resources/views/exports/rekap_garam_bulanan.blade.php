<table border="1" cellpadding="6" style="border-collapse:collapse; width:100%; font-family:sans-serif; font-size:12px;">
    <tr>
        <th colspan="8" style="font-size:16px; font-weight:bold; background:#0d1b2a; color:white; padding:10px;">
            REKAP PRODUKSI GARAM BULANAN - {{ $namaBulan }} {{ $tahunDipilih }}
        </th>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">Rp {{ number_format($data->sum('harga'), 0, ',', '.') }}</td>
    </tr>
    <tr><td colspan="8"></td></tr>
